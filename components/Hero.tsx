  ...
  return (
    <header>
      <div className="mx-auto max-w-6xl px-6 pt-16 pb-14 sm:pt-24 sm:pb-16">
        ...
        <p className="mt-4 font-display text-xl sm:text-2xl text-amber animate-rise [animation-delay:150ms] opacity-0 [animation-fill-mode:forwards]">
          {profile.title}
        </p>
        ...
        <div className="mt-8 flex flex-wrap gap-3 animate-rise [animation-delay:300ms] opacity-0 [animation-fill-mode:forwards]">
          <a
            href="#projects"
            className="inline-flex items-center gap-2 rounded-md bg-amber px-5 py-3 font-medium text-graphite hover:bg-amber/90 transition-colors"
          >
          ...
          <a
            ...
            download
            className="inline-flex items-center gap-2 rounded-md border border-line px-5 py-3 font-medium text-ink hover:border-teal hover:text-teal transition-colors"
          >
