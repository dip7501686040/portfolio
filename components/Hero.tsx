...
export default function Hero() {
  return (
    <header>
      <div className="mx-auto max-w-6xl px-6 pt-16 pb-14 sm:pt-24 sm:pb-16 flex flex-col sm:flex-row items-center sm:items-start gap-8 sm:gap-12">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/projects/profile.png"
          alt={profile.name}
          className="h-40 w-40 sm:h-52 sm:w-52 rounded-2xl object-cover border border-line shrink-0 animate-rise opacity-0 [animation-fill-mode:forwards]"
        />
