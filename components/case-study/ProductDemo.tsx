    ...
    <section id="demo" className="section-pad border-b border-line">
      <div className="mx-auto max-w-[1600px] px-6 lg:px-10">
        ...
        <p className="text-muted max-w-2xl mb-8 leading-relaxed">
          See the notification platform in action — from event creation and rule evaluation to AI
        ...
        <div className="relative aspect-video bg-panel2 border border-line rounded-xl overflow-hidden">
          {started && hasVideo ? (
            <video
              src={aiNotificationAssets.productVideo}
              poster={aiNotificationAssets.productPoster}
              controls
              autoPlay
            ...
            <>
              ...
              <img
                src={aiNotificationAssets.productPoster}
                alt="AI Notification System product demo preview"
                loading="lazy"
